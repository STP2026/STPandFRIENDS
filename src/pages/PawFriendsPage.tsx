      ...
      <main className="pt-20 pb-16">
        ...
        <section className="relative overflow-hidden bg-gradient-to-br from-primary/10 via-background to-emerald-50 dark:to-emerald-950/20 py-16 sm:py-24">
          <div className="container mx-auto px-4 text-center max-w-3xl">
            <div className="inline-flex items-center gap-2 bg-primary/10 text-primary px-4 py-2 rounded-full text-sm font-medium mb-6">
              ...
              {t('pawfriends.badge', 'Lokale Unterstützer')}
            </div>
            <h1 className="font-display text-4xl sm:text-5xl font-bold text-foreground mb-5 leading-tight">
              ...
              <span className="block text-primary mt-1">{t('pawfriends.heroSubtitle', 'Hundefreundliche Orte in der Region')}</span>
            </h1>
        ...
        <section className="py-14 sm:py-20 container mx-auto px-4 max-w-5xl">
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            {[
              {
                icon: '🏷️',
                title: t('pawfriends.benefit1Title', 'Sticker an der Tür'),
                desc: t('pawfriends.benefit1Desc', 'Ein offizieller PawFriends-Sticker kennzeichnet dein Lokal als hundefreundlichen Ort — sichtbar für alle Touristen.'),
              },
              {
                icon: '📍',
                title: t('pawfriends.benefit2Title', 'Pin auf der Karte'),
                desc: t('pawfriends.benefit2Desc', 'Dein Eintrag erscheint auf unserer interaktiven Karte — gefunden von Tausenden Touristen und Tierfreunden aus aller Welt.'),
              },
              {
                icon: '💚',
                title: t('pawfriends.benefit3Title', 'Gutes tun'),
                desc: t('pawfriends.benefit3Desc', 'Du unterstützt damit aktiv den Tierschutz in der Region Agadir-Taghazout und hilfst uns, mehr Hunden zu helfen.'),
              },
            ].map((item, i) => (
        ...
        <section className="py-12 bg-secondary/50">
          <div className="container mx-auto px-4 max-w-5xl">
            <h2 className="font-display text-2xl font-bold text-foreground mb-8 text-center">
              {t('pawfriends.whoTitle', 'Wer kann PawFriend werden?')}
            </h2>
        ...
        {pawFriends.length > 0 && (
          <section className="py-14 container mx-auto px-4 max-w-5xl">
            <h2 className="font-display text-2xl font-bold text-foreground mb-8 text-center">
              {t('pawfriends.currentTitle', 'Aktuelle PawFriends')}
            </h2>
        ...
        <section className="py-14 container mx-auto px-4 max-w-2xl">
          <div className="glass-card rounded-2xl p-8 sm:p-10 text-center border-2 border-primary/20 animate-fade-in">
            ...
            <h2 className="font-display text-2xl sm:text-3xl font-bold text-foreground mb-3">
              {t('pawfriends.ctaTitle', 'Jetzt PawFriend werden')}
            </h2>
