      ...
      <main className="pt-20 pb-12">
        <div className="container mx-auto px-4">
          <div className="mb-8 animate-fade-in">
            ...
            <p className="text-muted-foreground">{t('dogsPage.description')}</p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-8 animate-fade-in">
            ...
            <div className="flex gap-2">
              <Button variant={filter === "all" ? "default" : "outline"} size="sm" onClick={() => setFilter("all")} className="gap-1">
                <Filter className="w-4 h-4" />
                {t('dogsPage.filterAll')}
              </Button>
              <Button variant={filter === "vaccinated" ? "safe" : "outline"} size="sm" onClick={() => setFilter("vaccinated")} className="gap-1">
